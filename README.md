...
| 07 | Asymptotic Theory for Least Squares | partial | Theorem 7.1 totalized-estimator consistency and Theorem 7.2 projectionwise score CLT landed; Theorem 7.3 scalar-projection totalized-OLS CLT now includes inverse-gap/tightness and Slutsky assembly; vector/Cramér-Wold and ordinary-OLS packaging pending |
