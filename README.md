...
| 07 | Asymptotic Theory for Least Squares | partial | Theorem 7.1 totalized-estimator consistency and Theorem 7.2 projectionwise score CLT plus score-covariance `Ω` wrappers landed; Theorem 7.3 scalar-projection totalized-OLS CLT includes inverse-gap/tightness and Slutsky assembly; vector/Cramér-Wold and ordinary-OLS packaging pending |
