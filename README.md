...
| 07 | Asymptotic Theory for Least Squares | partial | Theorem 7.1 totalized-estimator consistency and Theorem 7.2 projectionwise score CLT landed; fixed-`Q⁻¹` scalar CLT, scaled residual control, feasible decomposition, and inverse-gap-conditional Slutsky assembly toward Theorem 7.3 landed; inverse-gap proof pending |
