...
|---:|---:|---|
| 0.0 | 5.7 | This is the formal spine of Frisch Waugh Lovell in Chapter three F W L: full beta two equals residualized beta. |
...
| 37.0 | 5.3 | The coefficient identity gives matching residuals; the full residual is already orthogonal to X one. |
| 42.3 | 4.3 | Proof map: normal equations plus annihilator bridges feed the coefficient and residual identities. |
| 46.6 | 4.0 | Lean packages F W L as reusable bridges, not one long calculation. |
