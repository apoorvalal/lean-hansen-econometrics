...
/-!
# Chapter 10 — Bootstrap delta method

Bootstrap continuous-mapping and delta-method wrappers (Hansen Theorem 10.7):
Gaussian limit transfer through a smooth function under compact-range,
compact-tail, and remainder-bound closeness hypotheses, with the indexed and
positive-definite variants.
-/
