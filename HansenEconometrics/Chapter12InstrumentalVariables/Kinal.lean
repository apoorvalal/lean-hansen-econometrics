...
/-- Correct central-Gram Gaussian support for the remaining Kinal calculation.
...
independence premises.  The coordinate facts and coefficient representation are
derived below. -/
