...
The [important-results explorer](results/index.qmd) contains 258 textbook result groups. Each group starts with a reader-facing textbook statement and has foldable plain-language documentation, formal statements, source links, and direct dependencies. Chapters 7--13 require an explicit TeX statement for every result group.
:::
