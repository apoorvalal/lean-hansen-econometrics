...
| Theorem 10.10 | In the smooth function model of Theorem 10.7, if for some |  |
| Theorem 10.11 | As `B → ∞`, the finite-replication trimmed bootstrap variance converges in bootstrap probability to the conditional variance of the trimmed bootstrap statistic | [chapter10_finiteReplicationVariance_tendsto_of_moments](../HansenEconometrics/Chapter10Bootstrap.lean) is the scalar moment-form bridge: finite-replication first/second moment convergence implies finite-replication variance convergence.<br>[chapter10_finiteReplicationCovarianceMat_tendsto_of_moments](../HansenEconometrics/Chapter10Bootstrap.lean) is the finite-dimensional covariance-matrix bridge from mean-vector and cross-moment convergence.<br>The concrete constructor deriving those moment premises from the bounded trimmed bootstrap WLLN remains to be connected. |
| Theorem 10.12 | Under the assumptions of Theorem 10.7, ˆV |  |
...
| [finiteReplicationMeanReal](../HansenEconometrics/Chapter10Bootstrap.lean), [finiteReplicationSecondMomentReal](../HansenEconometrics/Chapter10Bootstrap.lean), [finiteReplicationCrossMomentReal](../HansenEconometrics/Chapter10Bootstrap.lean), [finiteReplicationVarianceMomentReal](../HansenEconometrics/Chapter10Bootstrap.lean), [finiteReplicationCovarianceMomentReal](../HansenEconometrics/Chapter10Bootstrap.lean) | Finite-`B` replication moment, variance, and covariance functionals for real bootstrap statistics. |
| [finiteReplicationMeanVec](../HansenEconometrics/Chapter10Bootstrap.lean), [finiteReplicationCrossMomentMat](../HansenEconometrics/Chapter10Bootstrap.lean), [finiteReplicationCovarianceMomentMat](../HansenEconometrics/Chapter10Bootstrap.lean) | Finite-`B` replication mean-vector, cross-moment matrix, and covariance-matrix functionals for vector bootstrap statistics. |
