...
- The concrete nonparametric-bootstrap constructors still need to be added for the full
  ...
  refinement, test, and regression results. The scalar conditional-Chebyshev constructor for
  Theorem 10.2 is formalized.
...
| Theorem 10.2 | Bootstrap WLLN. If `Y_i` are independent and uniformly integrable, then `Ybar* − Ybar →p* 0` and `Ybar* →p* μ` | [chapter10_bootstrap_wlln_centered_of_tail_bound](../HansenEconometrics/Chapter10Bootstrap.lean) is the conditional-Markov/tail-bound bridge for the centered conclusion.<br>[chapter10_bootstrap_wlln_centered_of_second_moment_bound](../HansenEconometrics/Chapter10Bootstrap.lean) proves the centered conclusion from Hansen's empirical second-moment bound and the natural-power Marcinkiewicz WLLN.<br>[chapter10_bootstrap_wlln_centered_real_of_conditional_variance_bound](../HansenEconometrics/Chapter10Bootstrap.lean) is the scalar conditional-Chebyshev constructor from a conditional variance bound.<br>[chapter10_bootstrap_wlln_level_from_centered](../HansenEconometrics/Chapter10Bootstrap.lean) and [chapter10_bootstrap_wlln_level_of_second_moment_bound](../HansenEconometrics/Chapter10Bootstrap.lean) prove the second conclusion from centered bootstrap WLLN plus the ordinary WLLN.<br>The remaining concrete constructor is the fully expanded empirical-bootstrap covariance/norm inequality for vector observations. |
