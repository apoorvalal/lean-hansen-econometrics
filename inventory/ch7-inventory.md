...
| Theorem 7.12 | Under Assumptions 7.2, 7.3 and 7.4, for ˆC deﬁned in (7.35) with | Generic symmetric confidence-interval coverage convergence is formalized from absolute t-statistic convergence; the concrete homoskedastic ordinary-wrapper interval theorem is formalized. HC0/HC1 concrete interval wrappers remain. |
