...
| Theorem 7.13 | Under Assumptions 7.2, 7.3 and 7.4, as n → ∞, W (θ) − → | Generic multivariate Wald CMT, matrix-vector Slutsky support, and scalar one-degree-of-freedom HC0/HC1 Wald limits to `χ²(1)` are formalized; vector CLT/covariance packaging and final multivariate chi-square law identification remain. |
